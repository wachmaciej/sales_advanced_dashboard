...
def display_tab(df, available_years, default_years):
    ...
    with st.expander("Daily Price Filters (Top Listings)", expanded=True):
        ...
        with col1:
            ...
            if not default_daily_years: 
                default_daily_years = default_years
            elif len(default_daily_years) > 2: 
                default_daily_years = default_daily_years[-2:]
