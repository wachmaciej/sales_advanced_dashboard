...
# >> Price Range Columns <<
PRICE_RANGE_UK_COL = "Price Range UK"
PRICE_RANGE_US_COL = "Price Range US"

# >> Target Data Columns (from TARGETS sheet) <<
TARGET_DATE_COL = "Date"
DAILY_TARGET_GBP_COL = "Daily_Target_GBP"

# >> Target Configuration <<
AMAZON_CHANNEL_FILTER = "Amazon"  # Only channels containing "Amazon" have targets

# >> Price Range Channel Mapping <<
UK_CHANNELS = ["RA Amazon UK", "RA Website UK"]
US_CHANNELS = ["RA Amazon US", "RA Website US"]
PRICE_RANGES = ["Full Price Range", "Reduced Range", "Stragglers", "Zero Stock", "0"]
